...
最後更新：2026-08　原始大小：370,778,112 bytes　共 8 個 part（每份 <= 48MB）
...
```bash
cat tw_stock.db.part000 tw_stock.db.part001 tw_stock.db.part002 tw_stock.db.part003 tw_stock.db.part004 tw_stock.db.part005 tw_stock.db.part006 tw_stock.db.part007 > tw_stock.db
```

**方法三（Windows cmd，注意 part 檔名順序要正確，用 + 串接）**：

```cmd
copy /b tw_stock.db.part000+tw_stock.db.part001+tw_stock.db.part002+tw_stock.db.part003+tw_stock.db.part004+tw_stock.db.part005+tw_stock.db.part006+tw_stock.db.part007 tw_stock.db
```

合併後檔案的 sha256 應為：`81c16f4534f1ea767ed15feac0af44bc0109f400435f518c1dcc828c2fadaef6`（`tw_stock.db.manifest.json` 裡也有記錄，`merge_db.py` 會自動核對）。
