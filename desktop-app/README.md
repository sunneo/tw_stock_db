...
```
# Windows
powershell -ExecutionPolicy Bypass -File .uild.ps1 -ProxyMode inprocess
# 或 set FA_PROXY_MODE=inprocess 之後照常執行 build.bat / build.ps1

# Linux
PROXY_MODE=inprocess ./build.sh linux
```
